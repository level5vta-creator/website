...
// Translation System - UPDATED WITH BUY SECTION
const translations = {
    en: {
        // Navigation
        'nav.title': 'SUOLALA',
        ...
        // Buy Section - NEW
        'buy.title': 'Buy SUOLALA',
        'buy.subtitle': 'Get your $SUOLALA tokens with SOL in just a few steps',
        'buy.step1.title': 'Connect Wallet',
        'buy.step1.desc': 'Connect your Solana wallet (Phantom, Solflare, etc.)',
        'buy.step2.title': 'Enter SOL Amount',
        'buy.step2.desc': 'Enter amount of SOL you want to use',
        'buy.step3.title': 'Confirm Buy',
        'buy.step3.desc': 'Confirm transaction to receive SUOLALA',
        'buy.note': 'This section is for buying SUOLALA only. Always verify the contract address.',
    ...
    zh: {
        ...
        // Buy Section - NEW
        'buy.title': '购买 SUOLALA',
        'buy.subtitle': '仅需几步即可用SOL获取$SUOLALA代币',
        'buy.step1.title': '连接钱包',
        'buy.step1.desc': '连接您的Solana钱包（Phantom, Solflare等）',
        'buy.step2.title': '输入SOL数量',
        'buy.step2.desc': '输入您要使用的SOL数量',
        'buy.step3.title': '确认购买',
        'buy.step3.desc': '确认交易以接收SUOLALA',
        'buy.note': '此部分仅用于购买SUOLALA。请务必验证合约地址。',
...
function setupScrollAnimations() {
    ...
    // Observe elements to animate (including buy section elements)
    const elementsToAnimate = document.querySelectorAll('.feature-card, .nft-card, .token-stat-card, .roadmap-phase, .buy-step-fixed');
